...
class AST_Model:
    ...
    def fit(self, args, learning_params):
        # Set paths
        trainset_path = args.train_dataset_path  # path to training dataset.pkl
        validset_path = args.valid_dataset_path  # path to validation dataset.pkl
        save_model_dir = args.save_model_dir  # directory to save models for each epoch
